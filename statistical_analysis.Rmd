...
We regressed number of rat sightings against number of pizza restaurants, and obtained a parameter estimate and associated p-value. We found that for each additional pizza restaurant per zip code, number of rat sightings increased by an average of 0.565 (p-value = 0.001). 
...
Our $R^2$ value indicates that only 6.6% of the variability in number of rat sightings can be explained by the variability in number of pizza restaurants ($R^2$ = 0.066). This means that the majority of variability of rat sightings in explained by factors other than pizza restaurants. 
