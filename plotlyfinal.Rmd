...
```{r interactive-scatter, message=FALSE, warning=FALSE}
# Fit the model
...
```{r top10-rats, message=FALSE, warning=FALSE}
zipcode_summary |>
...
```{r top10-pizza, message=FALSE, warning=FALSE}
zipcode_summary |> 
...
```{r regression-line-only-interactive, message=FALSE, warning=FALSE}
# Fit the model
fit <- lm(ratreport_count ~ pizzarestaurant_count, data = zipcode_summary)
